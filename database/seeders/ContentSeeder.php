...
class ContentSeeder extends Seeder
{
  ...
  public function run(): void
  {
    ...
    Content::create([
      ...
      'judul' => '[]',
      'card_title' => 'tab',
      'domain_tableau' => 'https://public.tableau.com',
      'card_description' => 'views/ThePeriodicTableofWine/periodictableauofwineEN?:language=en-US&:display_count=n&:origin=viz_share_link',
      'card_grid' => 12,
      'x_value' => '[[]]',
      'y_value' => '[[]]',
      'color' => '[]'
